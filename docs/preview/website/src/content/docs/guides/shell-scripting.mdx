...
description: Shared-lib conventions and the shipped-bug rules for scripts/ — bash 3.2 limits, subshell die, pipe_ok, secrets in argv, and structural network isolation in selftests.
sidebar:
  order: 7
---

Moved verbatim from the
[`shell-scripting`](https://github.com/moneymikeMD/night-watchman/blob/main/skills/shell-scripting/SKILL.md)
skill.
