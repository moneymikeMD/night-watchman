...
description: Why a script with a write path must be structurally unable to reach a live target while under test, not just told not to.
sidebar:
  order: 8
---

Moved verbatim from
[`docs/testing-philosophy.md`](https://github.com/moneymikeMD/night-watchman/blob/main/docs/testing-philosophy.md).
