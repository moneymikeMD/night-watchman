...
implementation behind it. A work-order wave was dispatched through
...
WO-26 answered that by adding the Workflow tool as the second implementation
...
1. **The ticket as a cold-executable contract** — extracted into
