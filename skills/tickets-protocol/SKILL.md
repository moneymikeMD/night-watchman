...
Full reference: `to-issues/references/frontmatter.md`. Summary:
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/to-issues/scripts/issues.py lint  issues/   # file mode
python3 ${CLAUDE_PLUGIN_ROOT}/skills/to-issues/scripts/issues.py board issues/
python3 ${CLAUDE_PLUGIN_ROOT}/skills/to-issues/scripts/issues.py waves issues/
python3 ${CLAUDE_PLUGIN_ROOT}/skills/to-issues/scripts/issues.py next  issues/

# tracker mode, once adopted:
python3 ${CLAUDE_PLUGIN_ROOT}/skills/to-issues/scripts/issues.py lint  --source jira --jira-project PROJ
python3 ${CLAUDE_PLUGIN_ROOT}/skills/to-issues/scripts/issues.py board --source jira --jira-project PROJ
```
