...
A CLOSING STATE section is appended by the script rather than templated
here; the herdr provider also appends a MIXED TICKET one for an
executor:mixed ticket (the workflow provider does not yet).
-->
# @KEY@ worker brief
